...
class Building
{
    ...
    {
        return $"Name: {Name}, Address: {Address}, Area: {Area}, Floors: {NumberOfFloors}, Year Built: {YearBuilt}";
    }
}
...
class ResidentialBuilding : Building
{
    ...
    public override string ToString()
    {
        return base.ToString() + $", Apartments: {NumberOfApartments}, Apartment Type: {ApartmentType}";
    }
}
...
class CommercialBuilding : Building
{
    ...
    public override string ToString()
    {
        return base.ToString() + $", Building Type: {BuildingType}";
    }
}
